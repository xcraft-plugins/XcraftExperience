...
public class HelpCommand {
    public static void PluginInfo(Player player, JavaPlugin plugin) {
        ...
        if(player.hasPermission("xcraftexperience.check.other")) player.sendMessage(ChatColor.GRAY + "->" + MESSAGEHANDLER.getConfiguration().getString("BOTTLE_ADMIN_CHECK_HELP_TEXT"));
